...
import at.noahb.minecraftmcaintellijplugin.McaFileType;
...
public class McaFileEditorProvider implements FileEditorProvider, DumbAware {
	@Override
	...
	public FileEditor createEditor(@NotNull Project project, @NotNull VirtualFile file) {
		return new McaFileEditor(file, project);
	}
